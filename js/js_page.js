...
function homepage(_0x451dx2, _0x451dx3, _0x451dx4) {
  ...
  _0x451dx3 = -1 != _0x451dx2['innerHTML']['indexOf']('[tintuc]') ? '' : '<div class="box_item simpleCart_shelfItem"><div class="img"><a  href="' + _0x451dx4 + '">' + _0x451dx5 + '</a></div><div class="pro_content"><div class="clear"></div><div class="p_title"><a href="' + _0x451dx4 + '">' + removeHtmlTag(_0x451dx3, sumtitle) + '</a></div><div class="clear"></div><div class="gia_ban"><b class="item_price">' + price + ' </b><b>&nbsp;₫</b></div><div class="p_price"><a href="javascript:void(0);"><span class="item_add view_lft"><i class="fa fa-shopping-cart"></i> Mua</span></a><a href="' + _0x451dx4 + '"><span class="view_rgt"><i class="fa fa-eye"> Chi tiết</i></span></a></div></div></div>';
